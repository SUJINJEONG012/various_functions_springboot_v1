...
public class NoticeFileController {
	...
	/*
	 * 파일리스트 조회 => 공지사항에 첨부된 파일목록을 가져오는 RESTful API로 구현 이 API를 호출하여 프론드엔드에서 파일 목록을
	 * 가져올 수 있다.
	 */
...
//    }
	...
	// 첨부파일 다운로드
	@GetMapping({ "/admin/notice/{noticeId}/files/{fileId}/download", "/notice/{noticeId}/files/{fileId}/download" })
