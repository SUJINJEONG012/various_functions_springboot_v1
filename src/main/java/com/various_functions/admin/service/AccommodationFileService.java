...
public class AccommodationFileService {
	...
	public AccommodationsFileVo findFileByAccommodationAndFileId(Long accommodationId, Long fileId) {
	    return accommodationsFileMapper.findFileByAccommodationAndFileId(accommodationId, fileId);
	}
